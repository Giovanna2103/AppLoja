  ...
  return (
    <HomeStack.Navigator>
      <HomeStack.Screen
        name="Home"
        component={Home}
        options={{ headerTitle: '🌈 Rainbow Shop 🌈' , headerTitleAlign:'center'}}
      />
    </HomeStack.Navigator>
  );
}
  ...
  return (
    <CarrinhoStack.Navigator>
      <CarrinhoStack.Screen
        name="Carrinho"
        component={Carrinho}
        options={{ headerTitle: '🌈 Rainbow Shop  | Carrinho 🌈' , headerTitleAlign:'center'}}
      />
    </CarrinhoStack.Navigator>
  );
}
  ...
  return (
    <CadastroStack.Navigator>
      <CadastroStack.Screen
        name="Cadastro"
        component={Cadastro}
        options={{ headerTitle: '🌈 Rainbow Shop  | Cadastro 🌈' , headerTitleAlign:'center'}}
      />
    </CadastroStack.Navigator>
  );
}
  ...
  return (
    <PerfilStack.Navigator>
      <PerfilStack.Screen
        name="Perfil"
        component={Perfil}
        options={{ headerTitle: '🌈 Rainbow Shop  | Perfil 🌈' , headerTitleAlign:'center'}}
      />
    </PerfilStack.Navigator>
  );
}
  ...
  return (
    <LoginStack.Navigator>
      <LoginStack.Screen
        name="Login"
        component={Login}
        options={{ headerTitle: '🌈 Rainbow Shop  | LOGIN 🌈' ,headerTitleAlign:'center'  }}
      />
    </LoginStack.Navigator>
  );
}
